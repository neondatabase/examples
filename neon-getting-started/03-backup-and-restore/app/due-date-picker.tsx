...
export function DueDatePicker() {
  ...
  return (
    <div className="relative min-w-0">
      ...
      {isOpen && (
        <div
          className="absolute right-0 z-10 mt-2 w-[min(18rem,calc(100vw-2rem))] rounded-xl border border-zinc-200 bg-white p-3 shadow-lg sm:left-0 sm:right-auto dark:border-zinc-800 dark:bg-zinc-900"
          role="dialog"
